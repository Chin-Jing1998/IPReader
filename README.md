...
以下为 **2026 年 8 月 26 日**的数据快照：

| 指标         |          规模 | 说明                                   |
| ------------ | ------------: | -------------------------------------- |
| 收录文献     |     **88 部** | 主干文献 7 部，扩展文献 81 部          |
| 正文页       |  **6,247 页** | 法规、司法解释、指南与实务规范正文     |
| 术语词条     |  **1,035 个** | 按 24 个主题分组，含释义、出处与关联项 |
| 图谱节点     |  **7,282 个** | 文献、章节、小节与术语节点             |
| 图谱关系     | **15,520 条** | 层级、引用、术语与关联关系             |
| 法条溯源     |  **2,521 条** | 覆盖 70 部法律法规的条文正文           |
| 法条引用关系 |  **3,014 条** | 支持从法条反查引用它的章节             |
| 行内术语链接 | **19,104 处** | 正文中的术语可直接跳转词条             |
...
- **55 部**法律、行政法规、部门规章与其他规范性文件，涵盖商标、著作权、反垄断、反不正当竞争、植物新品种、集成电路布图、海关保护及知识产权管理等主题。

知识图谱默认展示主干文献与 76 部可视化扩展文献；部分政策与标准索引文件仅保留在正文、目录和搜索中，不参与图谱绘制。
